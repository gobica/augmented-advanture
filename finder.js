...
AFRAME.registerComponent('finder', {
    ...
    _loadLocations: function (longitude, latitude) {
        ...
        fetch(`https://cors.bridged.cc/https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${latitude},${longitude}&type=church&radius=1000&key=AIzaSyCC2aDWxhRGLni1Tz5MlhdX9-6WwX5d3kM`)
